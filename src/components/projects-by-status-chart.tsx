...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
  PROPOSAL: { label: "Proposal", color: "#F5A524" },
  IN_PROGRESS: { label: "In Progress", color: "#006FEE" },
  REVIEW: { label: "Review", color: "#7828C8" },
  COMPLETED: { label: "Completed", color: "#17C964" },
  CANCELLED: { label: "Cancelled", color: "#F31260" },
};
...
export function ProjectsByStatusChart({ data }: ProjectsByStatusProps) {
